...
| | |
|---|---|
| Job asks | `runs-on: [self-hosted, linux, x64, ubuntu-24.04]` |
| Pool carries | `["self-hosted", "linux", "x64", "ubuntu-24.04", "home-vm"]` |
| Result | Served — `home-vm` is spare, not an obstacle |
