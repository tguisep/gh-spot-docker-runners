...
## [0.7.0](https://github.com/tguisep/gh-spot-docker-runners/compare/v0.6.0...v0.7.0) (2026-08-31)


### Features

* a web dashboard, CPU/memory sampling, and --watch ([4ffcc85](https://github.com/tguisep/gh-spot-docker-runners/commit/4ffcc850a632fe41c31648a2e0558689529823d7))
* add `ghspot stats` ([67e0317](https://github.com/tguisep/gh-spot-docker-runners/commit/67e031701b903b37e914c214374f7e522d9cda29))
* **ansible:** deploy and report the dashboard ([c2f2121](https://github.com/tguisep/gh-spot-docker-runners/commit/c2f21216f58f5c39a03fdbed247f193cb7cec58a))
...
* **api:** add GET /runners/{ref}/job-logs ([fc7a9bf](https://github.com/tguisep/gh-spot-docker-runners/commit/fc7a9bf738462cffd2d8d585775197890e9a5aeb))
...
* **api:** serve CPU and memory behind ?usage=true ([87accea](https://github.com/tguisep/gh-spot-docker-runners/commit/87acceaa7efe18cea79efa8da5ec5378e4a536e0))
* **api:** serve the dashboard at /ui when it has been built ([451ddb3](https://github.com/tguisep/gh-spot-docker-runners/commit/451ddb3f655071a888cdae46b1194b9bddfac22f))
...
* bound the host, not just the pool ([d463ea3](https://github.com/tguisep/gh-spot-docker-runners/commit/d463ea379a1b7fa04b428a109970a2848b344230))
...
* **cli:** add --job to `runner logs` ([6e1092a](https://github.com/tguisep/gh-spot-docker-runners/commit/6e1092ad02c070f32e29647751bfae334a56ab2c))
* **cli:** add --watch to the listings, and --usage to runner list ([93b9ed1](https://github.com/tguisep/gh-spot-docker-runners/commit/93b9ed1267d712cdb9d4ea37279440deea8744f4))
* **cli:** add `ghspot setup`, a first-run wizard ([1289d4e](https://github.com/tguisep/gh-spot-docker-runners/commit/1289d4ed788680b7fcf44409c5a1ac501b5d06e2))
...
* **cli:** report the API and dashboard in `config validate` ([e3c939d](https://github.com/tguisep/gh-spot-docker-runners/commit/e3c939dd92aaccb9091cdfa4826d0cb3756a4880))
...
* **config:** bound the container count by the core count, by default ([c038120](https://github.com/tguisep/gh-spot-docker-runners/commit/c038120218495eb9f82a1b25f25ca753c722606a))
...
* **config:** pools in their own files, php-fpm style ([c26649d](https://github.com/tguisep/gh-spot-docker-runners/commit/c26649d451afd923e9e7fa38bea05b0561207b2b))
* **config:** read [capacity] and a pool's priority ([00972e7](https://github.com/tguisep/gh-spot-docker-runners/commit/00972e76d28f261812555a3c904991bc0489021e))
...
* **config:** read pools from an included directory ([09e766b](https://github.com/tguisep/gh-spot-docker-runners/commit/09e766b769e6d0f1bb9be6c343ccb41516e41de0))
...
* **core:** admit launches against the whole host ([6cfcc66](https://github.com/tguisep/gh-spot-docker-runners/commit/6cfcc66d49258d33398445490a318f8f81c7848e))
...
* **core:** sample a container's CPU and memory ([bfc88fd](https://github.com/tguisep/gh-spot-docker-runners/commit/bfc88fdc622b0e00ea383d4a5f755e03e6db81c4))
...
* **dashboard:** show a setup screen on a fresh install ([1b35bc8](https://github.com/tguisep/gh-spot-docker-runners/commit/1b35bc89171a795390e89ffd77bdce2fdafa2234))
* **dashboard:** show both logs on one screen ([48797ae](https://github.com/tguisep/gh-spot-docker-runners/commit/48797ae2c32860c0b561cd3a35d6dd1d01bb883b))
* **dashboard:** the operator dashboard, in React and TypeScript ([233b27c](https://github.com/tguisep/gh-spot-docker-runners/commit/233b27c1183fac76e83a1426656a05f4df0506c9))
...
* **docker:** probe what the host is actually doing ([9648fda](https://github.com/tguisep/gh-spot-docker-runners/commit/9648fdae84a0354986a24908b4b778cbd03630a2))
...
* **domain:** decide whether a planned launch may actually start ([a0f6379](https://github.com/tguisep/gh-spot-docker-runners/commit/a0f6379b79febf2762a2692f0fbafea4bdde4094))
...
* **domain:** make priority a share rather than a rank ([980e968](https://github.com/tguisep/gh-spot-docker-runners/commit/980e9688890f85bdd90630a81e3c3c5c04f93b2d))
...
* **github:** fetch the forge's log for a finished job ([f551e16](https://github.com/tguisep/gh-spot-docker-runners/commit/f551e16f2629e7c4cdea09d90289fc68c096b8de))
...
* guide the first run, and bound containers by core count ([0503e76](https://github.com/tguisep/gh-spot-docker-runners/commit/0503e7695e7132f13eb685b4892cf9f6670ab5de))
...
* a tick that cannot see the fleet must not destroy it ([1c815d3](https://github.com/tguisep/gh-spot-docker-runners/commit/1c815d3c886fe945d979ea1d14a040385d53541f))
...
* **ansible:** keep the per-pool template in step with the inline one ([932caaa](https://github.com/tguisep/gh-spot-docker-runners/commit/932caaac2a117106542a5d7cc2612c013c047f6c))
* **application:** never reap on a tick that cannot see the containers ([7294d45](https://github.com/tguisep/gh-spot-docker-runners/commit/7294d45308c2cad9f23e51ece3ba9c9ad2777f15))
...
* **ci:** build the release commit, not its tag ([19b13cd](https://github.com/tguisep/gh-spot-docker-runners/commit/19b13cdb74249dba6d662c8b581d1f5f1f80fc91))
...
* **cli:** escape error messages before Rich reads them as markup ([8ce88ca](https://github.com/tguisep/gh-spot-docker-runners/commit/8ce88ca03b3acf438f0ab4fb5119c398887c69b8))
...
* **dashboard:** bump three dependencies off published advisories ([d68c31b](https://github.com/tguisep/gh-spot-docker-runners/commit/d68c31b1cdc0cbf1c276c96e08524fc857689ee2))
* **dashboard:** proxy the API docs link in development ([0059cf9](https://github.com/tguisep/gh-spot-docker-runners/commit/0059cf98927fec1139bf5d8890e3d1654c54a2d1))
* **dashboard:** take defineConfig from vitest, not vite ([135c5b6](https://github.com/tguisep/gh-spot-docker-runners/commit/135c5b619faaa094132ea060c5a8b52622451046))
...
* describe GPU pools in the README, and the vanished-runner symptom ([b8662bf](https://github.com/tguisep/gh-spot-docker-runners/commit/b8662bf879a655c821f76be08a4a381e7c2391b2))
...
* document host capacity limits ([1f06301](https://github.com/tguisep/gh-spot-docker-runners/commit/1f063016a3918e23fbb92150964ef3fcb029e237))
...
* document the dashboard, --watch and --usage ([dff6cc6](https://github.com/tguisep/gh-spot-docker-runners/commit/dff6cc6369155ac31d57b65848c35f3ff575ef36))
...
* document the pool directory and how files merge ([90862df](https://github.com/tguisep/gh-spot-docker-runners/commit/90862df32f3ecd4c9ee1be2729aec62028bdb98f))
...
* document the setup wizard and the core-count default ([9aaca59](https://github.com/tguisep/gh-spot-docker-runners/commit/9aaca59c8b3506ad07894f408b96124064f5512d))
...
* explain why there are two logs ([9997a67](https://github.com/tguisep/gh-spot-docker-runners/commit/9997a67d88ab21d6798901e9f35adfbac7dde8ad))
...
* build the dashboard, and ship it in the package ([5ea473a](https://github.com/tguisep/gh-spot-docker-runners/commit/5ea473af17038981d766761b2c21efe246be2598))
...
* **deps:** bump the actions group with 2 updates ([7965bf5](https://github.com/tguisep/gh-spot-docker-runners/commit/7965bf5f4328f0bd081be6c3e2f3d462b62ff6a5))
* **deps:** bump the actions group with 2 updates ([5a68639](https://github.com/tguisep/gh-spot-docker-runners/commit/5a68639a92406c9ee52f9a083de4cc37e0ac8f49))
...
* one workflow per concern, filtered by path ([3feaa2b](https://github.com/tguisep/gh-spot-docker-runners/commit/3feaa2b8f463b11f47e9bd08a8a8d334c3ca7d5d))
* one workflow per concern, filtered by path ([06bd62f](https://github.com/tguisep/gh-spot-docker-runners/commit/06bd62fd134a270526c951305d3e486d54ef0173))
...
* run on the fleet wherever it can ([1663de7](https://github.com/tguisep/gh-spot-docker-runners/commit/1663de76bc48757a268ae5ad56f5f705fa76db11))
