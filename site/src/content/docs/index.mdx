...
- A credential **scoped to the repositories it will serve**, not to everything the account can
  reach — a fine-grained personal access token or a GitHub App — carrying
  **Administration: read & write** (to register runners) and **Actions: read** (to see queued
